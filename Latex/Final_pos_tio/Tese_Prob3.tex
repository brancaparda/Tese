...
Here the case described on the previous chapter is extended by considering a firm, which has an established product in the market, and wants to find the best time to:
\begin{enumerate}
...
Finally, in view of the results shown in Figure \ref{fig:2_x1Ai}, we obtain that the larger the innovation level, the higher is the expected profit during the simultaneous production period and, hence, the more attractive is the investment on the \textit{new} product.

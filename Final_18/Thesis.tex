...
\input{Tese_Notation} % file "Thesis_Nomenclature.tex"
\cleardoublepage 
%
% Add entry in the table of contents as section
%\phantomsection
...
\input{Tese_Prob1} % file "Thesis_Background.tex"
\cleardoublepage

\input{Tese_Prob2} % file "Thesis_Implementation.tex"
\cleardoublepage
...
%\input{Thesis_new_file} % add new .tex files for new chapters
% \cleardoublepage
\input{Tese_Prob3} % file "Thesis_Implementation.tex"
\cleardoublepage
